            ...
            <div class=".d-flex, justify-content-between" style="display: flex;">
                ...
                <div class="opciones" style="text-align: end;">
                    <form method="POST" name="redireccion" id="redireccion" action="">
                        <button type="submit" name="index" class="btn btn-outline-dark">Principal</button>
        ...
        <body>
            ...
            <div class="container-fluid" style="width: 95%;">
                <div class=".d-flex, justify-content-between" style="display:flex;">
                    ...
                    <button type="button" class="btn btn-sm btn-primary" style="align-items:center" data-bs-toggle="modal" data-bs-target="#modal"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
