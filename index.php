...
<body id="top">
  ...
  <nav class="navbar navbar-expand-sm bg-info navbar-light navbar-fixed-top">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">
        <!-- <div class="rounded-pill"><i class="bi bi-tools"></i></div> -->
        <img src="assets/img/logo.png" alt="Avatar Logo">
        <a class="navbar-brand letra-normal" href="#" style="color: #273746;">HERRAMIENTA PARA DESARROLLO WEB</a>
      </a>
    </div>
  </nav>
  ...
  <div class="col-12 col-centrada container" style="max-width: 98% !important;">
    ...
    <div class="row">
      ...
      <div class="col-sm-12 col-md-2 borde-derecho">
        <button title="Limpiar Campos" type="button" class="btn letra-media btn-sm boton7 izquierda color7 w-100" onclick="limpiar_formulario('pruebas')"><i class="bi bi-menu-button-wide-fill"></i><b> PROYECTO - BASE
            DATOS</b></button>
        <hr>
      </div>
      <!-- Columna de la Derecha -->
      <div class="col-sm-12 col-md-10">
        <button id="generado" title="Copiar al Portapapeles" type="button" class="btn btn-success izquierda letra-media btn-sm w-100" onclick="clipboard('text1')"><b>CODIGO
            GENERADO</b></button>
        <hr>
      </div>
    </div>
      ...
      <div class="col-sm-12 col-md-2 borde-derecho">
        <form method="POST" name="proyecto" id="proyecto" action="proyecto.php">
          <div class="col-sm-12 col-md-12">
            <input type="text" name="proyecto" class="form-control fondo11 form-control-sm mb-1" placeholder="Carpeta Proyecto" required>
          </div>
          <div class="col-sm-12 col-md-12">
            <input type="text" name="base" class="form-control fondo11 form-control-sm mb-1" placeholder="Base de Datos" required>
          </div>
          <!-- Input Hidden Requerimiento para Update -->
          <input type='hidden' id='ruta' name='ruta' value=<?php $ruta; ?> />
          <div class="col-sm-12 col-md-12 mt-2">
            <button title="Generar Proyecto" type="submit" name="submit" class="btn mb-2 btn-sm izquierda letra-media boton8 w-100"><i class="bi bi-menu-button-wide-fill"></i><b>
        ...
        <div class="col-12 borde-derecho">
          <button title="Limpiar Campos" type="button" class="btn letra-media izquierda btn-sm boton9 color7 w-100" onclick="limpiar_formulario('pruebas')"><i class="bi bi-table"></i><b> Limpiar </b></button>
        </div>
        <hr>
        <form method="POST" name="pruebas" id="pruebas" action="generar.php">
          ...
          <!-- <hr> -->
          <br>
          <button title="Generar Codigo" id="botoncodigo" type="submit" name="submit" class="btn boton10 mb-2 letra-media w-100"><i class="bi bi-code-square"></i><b> GENERAR CODIGO COMPLETO</b></button>
        </form>
        ...
        <form method="POST" name="radios" id="radios" action="generarRadio.php">
          ...
          <button title="Generar Codigo" id="botonradio" type="submit" name="submit" class="btn boton10 mb-2 letra-media w-100"><i class="bi bi-code-square"></i><b> GENERAR CODIGO</b></button>
        </form>
      </div>
