...
if (!empty($proyecto)) {
    ...
    //----- Rutina Radio Option -----//
    if ($_POST['radio'] == 'radio11') {

        $devu = '';
        $devu .= '<!-- Radio para Insert -->' . "\r";
        $devu .= '<div class="form-check">' . "\r";
        $devu .= '<input type="radio" class="form-check-input" id="radio1" name="sexo_i" value="FEMENINO">FEMENINO' . "\r";
        $devu .= '</div>' . "\r";
        $devu .= '<div class="form-check">' . "\r";
        $devu .= '<input type="radio" class="form-check-input" id="radio2" name="sexo_i" value="MASCULINO">MASCULINO' . "\r";
        $devu .= '</div>' . "\r\r";

        $devu .= '<!-- Radio para Update -->' . "\r";
        $devu .= '<div class="form-check">' . "\r";
        $devu .= '<input type="radio" class="form-check-input" id="radio1" name="sexo_u" value="FEMENINO">FEMENINO' . "\r";
        $devu .= '</div>' . "\r";
        $devu .= '<div class="form-check">' . "\r";
        $devu .= '<input type="radio" class="form-check-input" id="radio2" name="sexo_u" value="MASCULINO">MASCULINO' . "\r";
        $devu .= '</div>' . "\r\r";

        $devu .= '<!-- Radio para Delete -->' . "\r";
        $devu .= '<div class="form-check">' . "\r";
        $devu .= '<input type="radio" class="form-check-input" id="radio1" name="sexo_d" value="FEMENINO">FEMENINO' . "\r";
        $devu .= '</div>' . "\r";
        $devu .= '<div class="form-check">' . "\r";
        $devu .= '<input type="radio" class="form-check-input" id="radio2" name="sexo_d" value="MASCULINO">MASCULINO' . "\r";
        $devu .= '</div>' . "\r";
